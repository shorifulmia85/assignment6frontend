...
const Footer = () => {
  return (
    <div>
      <footer className="bg-[#171717] -mb-8 text-white">
        <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
          <div className="lg:flex lg:items-start lg:gap-8">
            ...
            <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
              ...
              <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                <form className="w-full">
                  ...
                  <div className="border border-gray-100 p-2 focus-within:ring-3 sm:flex sm:items-center sm:gap-4">
                    ...
                    <button className="mt-1 w-full bg-primary-foreground text-primary hover:text-primary-foreground border px-6 py-3 text-sm font-bold tracking-wide uppercase transition-none  sm:mt-0 sm:w-auto sm:shrink-0">
                      Sign Up
                    </button>
                  </div>
                </form>
              ...
              <div className="col-span-2 sm:col-span-1">
                <p className="font-medium text-muted">Downloads</p>
